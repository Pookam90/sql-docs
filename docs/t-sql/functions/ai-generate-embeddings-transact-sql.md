...
> [!NOTE]  
> `AI_GENERATE_EMBEDDINGS` is available in [!INCLUDE [ssazuremi-md](../../includes/ssazuremi-md.md)]  with the SQL Server 2025 and the **Always-up-to-date** [update policy](/azure/azure-sql/managed-instance/update-policy).
